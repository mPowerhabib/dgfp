...
public class WomanServiceModeOption extends ServiceModeOption {
    ...
    @Override
    public String name() {
       return Context.getInstance().getStringResource(R.string.elco_register);
    }
    ...
    public ClientsHeaderProvider getHeaderProvider() {
        return new ClientsHeaderProvider() {
            ...
            public int[] headerTextResourceIds() {
                return new int[]{
                        R.string.hh_profile, R.string.elco_unique_id, R.string.header_other_info,
                        R.string.elco_lmp,R.string.elco_psrf_due_date
                        };
            }
        };
    }
